...
<body>
					...
					<ul class="navbar-nav py-0 px-3 active">				
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="submenu" style="background-color: #E2FDFA; border: 1px solid #a5cda5;">						
								<a class="dropdown-item active" style="color: #060B95;" href="ballance.php">Bieżący miesiąc</a>
	...
	<div class="container my-3 text-center pb-5">
		...
		<div class="row">	
				...
				<h2 class="col-10 col-md-6 font-weight-bold rounded mx-auto"><i class="icon-calendar mr-3"></i>Bieżący miesiąc</h2>			
